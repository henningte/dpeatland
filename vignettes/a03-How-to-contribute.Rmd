...
Everybody who is author of a data set suitable for dpeatland (see next section) and has the agreement of any co-authors to share the data and to make them co-authors can contribute data.

### What data can be contributed?

Any data that provide information on peatland processes can be contributed. In particular, data from individual lab or field experiments or observational studies published or unpublished can be contributed.  

This comprises for example:  

- Environmental conditions (air temperature, precipitation, photosynthtic active radiation, soil temperatures, water table levels, soil moistures, ...).  

- Decomposition data (mass losses/mass remaining in litter bag studies, peat masses and ages, ...).  

- Peat properties (physical properties, e.g. peat age, bulk density, loss on ignition, hydraulic conductivity, porosity, etc., and chemical properties, e.g. pH value, element contents, organic matter fractions, spectral data, etc.).  

- Other processes (e.g. biological N$2$-fixation rates, gross/net primary production, leaf senescence rates, leaching rates, ...).  

- Macrofossil data and current vegetation.  
...
Go to [the project's GitHub repository](https://github.com/henningte/dpeatland) and download the zip folder [data_template.zip](https://github.com/henningte/dpeatland/blob/master/data_template.zip). This folder contains a set of csv/docx templates, where you can enter your data, and the data policy agreement for dpeatland. A detailed manual to fill in the data is provided below. Note that any data contributor must agree to the [authorship guidelines for the data compendium](a06-Authorship-guidelines-for-dpeatland.html)

If you have questions, don't hesitate to contact me!

### How to contribute to the data paper?

If you submit your data before January 31, 2021, you send a request to become co-author of the data paper and you agree to the [authorship guidelines for the data paper](a07-Authorship-guidelines-for-the-data-paper.html), you will not only becom co-author of the data compendium, but also of the corresponding data paper.

For organizing the data collection and developing the technical infrastructure, as well as providing some data, and because I need to include it into my PhD, I will be the first author. My supervisors will become last authors. All other contributors will be sorted in alphabetical order.
...
1. Go to [the project's GitHub repository](https://github.com/henningte/dpeatland) and download the zip folder [data_template.zip](https://github.com/henningte/dpeatland/blob/master/data_template.zip). This folder contains a detailed manual and a set of csv/docx templates where you can enter your data.
...
c("sample_data.csv", "Data on peat/DOM/vegetation properties (for example peat age, N content, ...)."),
c("environmental_data.csv", "Data on environmental conditions (for example air tmeperature, precipitation, water table depth, soil temperature, ...)."),
